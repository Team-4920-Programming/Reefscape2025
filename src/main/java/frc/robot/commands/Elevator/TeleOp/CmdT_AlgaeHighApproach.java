...
public class CmdT_AlgaeHighApproach extends Command {
  ...
  public CmdT_AlgaeHighApproach(CoralElevatorSubsystem elevatorSS) {
  ...
  public void execute() {
        ...
        m_ElevatorSubsystem.setArmPosition(AlgaeHighApproach.height, AlgaeHighApproach.elbow, AlgaeHighApproach.wrist);
      }
