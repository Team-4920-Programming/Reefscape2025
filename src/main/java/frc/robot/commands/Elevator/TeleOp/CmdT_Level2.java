...
public class CmdT_Level2 extends Command {
  ...
  public boolean isFinished() {
    return (Math.abs(m_ElevatorSubsystem.getHeightLaserMeters() - Level2.height) < 0.1) && (Math.abs(m_ElevatorSubsystem.GetElbowAngle() - Level2.elbow) < 5) && (Math.abs(m_ElevatorSubsystem.GetWristAngleWorldCoordinates() - Level2.wrist) < 5) ;
  }
}
