...
public class CmdT_Level2 extends Command {
  ...
  public void execute() {
    ...
    if (m_ElevatorSubsystem.getHeightMeters() < Level2.height )
    {
    ...
    if (m_ElevatorSubsystem.GetElbowAngle() < Level2.elbow )
    {
      ElbowUp = true;
      ElbowDown = false;
    ...
    if (m_ElevatorSubsystem.GetWristAngleWorldCoordinates() < Level2.wrist )
    {
      WristUp = true;
      WristDown = false;
    ...
    {
        m_ElevatorSubsystem.SetElevatorPosition(Level2.height);
    }
    ...
    {
      if (Level2.elbow >0 && Level2.elbow <190)
      {
    ...
    if (ElbowUp && ElevatorClearForElbowUp && WristClearforElbowUp)
      m_ElevatorSubsystem.SetElbowAngle(Level2.elbow);
    ...
    {
      m_ElevatorSubsystem.SetWristAngle(Level2.wrist);
    }
