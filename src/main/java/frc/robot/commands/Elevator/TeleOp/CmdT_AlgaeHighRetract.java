...
public class CmdT_AlgaeHighRetract extends Command {
  /** Creates a new CmdT_Level1. */
  CoralElevatorSubsystem m_ElevatorSubsystem;
  public CmdT_AlgaeHighRetract(CoralElevatorSubsystem elevatorSS) {
  ...
  public void execute() {
        ...
        m_ElevatorSubsystem.setArmPosition(AlgaeHighRetract.height, AlgaeHighRetract.elbow, AlgaeHighRetract.wrist);
