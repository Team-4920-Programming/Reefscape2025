...
public class MoveElbowToAngle extends Command {
  ...
  double angle;
  public MoveElbowToAngle(CoralElevatorSubsystem elevatorSS, double angleSetpoint) {
  ...
  @Override
  public void execute() {
    m_ElevatorSubsystem.SetElbowAngle(angle);
  }
  ...
  public boolean isFinished() {
    double difference = Math.abs(m_ElevatorSubsystem.GetElbowAngle() - angle);
    return difference < 5;
  }
}
