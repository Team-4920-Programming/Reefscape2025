...
public class CmdA_Level4Transport extends Command {
  /** Creates a new CmdT_Level1. */
  CoralElevatorSubsystem m_ElevatorSubsystem;
  public CmdA_Level4Transport(CoralElevatorSubsystem elevatorSS) {
  ...
  public void execute() {
    DogLog.log("Auto/Level4Cmd/CommandStatus", "executing");
        ...
        m_ElevatorSubsystem.setArmPosition(Level4TransportUp.height, Level4TransportUp.elbow, Level4TransportUp.wrist);
      }
