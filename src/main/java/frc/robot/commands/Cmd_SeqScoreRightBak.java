...
public class Cmd_SeqScoreRightBak extends SequentialCommandGroup {
  /** Creates a new Cmd_SeqRemoveAlgea. */
  public Cmd_SeqScoreRightBak(CoralElevatorSubsystem Coral_SS, SwerveSubsystem Drive_SS,ReefSurveySubsystem Reef_SS) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new CmdT_Level4_Far(Coral_SS),
