...
public class CmdA_DriveToReefPositionV7_Test extends Command {
  ...
  public CmdA_DriveToReefPositionV7_Test(SwerveSubsystem DriveSubsystem, int position) {
  ...
  public void execute() {
    ...
    if ((Math.abs(currentPose.getY() - target.getY()) >=   DriveToPoseOld.driveTolerance || !thetaController.atSetpoint()) && currentDistance <= 0.1){
