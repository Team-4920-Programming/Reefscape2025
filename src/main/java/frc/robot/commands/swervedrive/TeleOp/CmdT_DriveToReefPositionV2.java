...
public class CmdT_DriveToReefPositionV2 extends Command {
  ...
  boolean inter;
  public CmdT_DriveToReefPositionV2(SwerveSubsystem DriveSubsystem, DataHighwaySubsystem data, int Position) {
  ...
  //   ReefPose = new Pose2d(x,y, Rotation2d.fromDegrees(rot));
    ...
    XPID.setTolerance(0.0675);
    YPID.setTolerance(0.0675);
