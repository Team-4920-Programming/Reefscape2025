...
public class CmdT_DriveToPoseRelative extends Command {
  ...
  boolean inter;
  public CmdT_DriveToPoseRelative(SwerveSubsystem DriveSubsystem, double maxSpeed, double x, double y, double rot) {
