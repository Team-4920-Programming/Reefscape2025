...
public class CmdT_DriveToAlgaeRemoval extends Command {
  ...
  boolean inter;
  public CmdT_DriveToAlgaeRemoval(SwerveSubsystem DriveSubsystem, double maxSpeed) {
  ...
  //   double Reef_Rot = ReefPose.getRotation().getDegrees()+180;
    ...
    // }
    double RotVel = RotPID.calculate(CurrentRot,target.getRotation().getDegrees() + 180);
