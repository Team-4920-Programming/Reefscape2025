...
public class CmdT_DriveToPoseRelativeBackAwayFromReef extends Command {
  ...
  boolean inter;
  public CmdT_DriveToPoseRelativeBackAwayFromReef(SwerveSubsystem DriveSubsystem, double maxSpeed, double x, double y, double rot) {
